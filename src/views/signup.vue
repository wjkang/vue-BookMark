<template>
    ...
    <div class="container">
        ...
        <div class="signup_forms" class="signup_forms">
            ...
            <button type="button" id="signup_forms_submit"><span><strong>Sign Up</strong></span></button>
        </div>
    </div>
    </div>
    <div class="footer">
        <div class="footer_signup_link">
            <a class="signup_link" href="register.html">Login</a>
        </div>
    </div>
</template>
<style scoped>
    ...
    .login_bg {
        ...
        bottom: 0;
        left: 0;
        background-image: url(../assets/image/u4.jpg);
